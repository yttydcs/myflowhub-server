...
func main() {
	...
	flag.StringVar(&opts.ParentEndpoint, "parent-endpoint", opts.ParentEndpoint, "parent endpoint, e.g. tcp://127.0.0.1:9000")
	...
	flag.BoolVar(&opts.RFCOMMEnable, "rfcomm-enable", opts.RFCOMMEnable, "enable bluetooth rfcomm listener (not implemented)")
